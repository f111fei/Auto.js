...
import com.siranyang.fastautolib.BuildConfig
import com.siranyang.fastautolib.Pref
...
open class AssetsProjectLauncher(private val mAssetsProjectDir: String, private val mActivity: Context) {
    ...
    fun launch(activity: Activity?, subDir: String) {/*
        ...
        //mProjectConfig.mainScriptFile = scriptName+".js";
        //setKey(mProjectConfig)
...
//    private fun runScript(activity: Activity?, scriptName: String) {
//        if (mScriptExecution != null && mScriptExecution!!.engine != null &&
//                !mScriptExecution!!.engine.isDestroyed) {
//            return
//        }
//        try {
//            val source = JavaScriptFileSource(scriptName, mMainScriptFile)
...
//    }
    ...
    private fun prepare() {
        ...
        try {
            PFiles.copyAssetDir(mActivity.assets, "scripts", mProjectDir, null)
